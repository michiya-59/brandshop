...
print '<br>';
print '<br>';
print '<form action="product_branch.php" method="post">'; //参照、追加、修正、削除機能を果たすために,product_branch.phpに飛ばしている
while(true)
{
...
?>
<br>
<a href="../staff/staff_top.php">トップメニューへ</a><br>
