...
try
{
$product_code = $_GET['productcode']; //product_branch.phpからURLパラメータによって商品コードをGETで受け取る

// 削除する商品の情報をデータベースから持ってきている
...
// 写真が4枚の時の削除するための商品を確認として一度表示させる処理。
if($product_gazou4 === $product_gazou4 && $product_gazou5 === '' )
  ...
  // 写真が5枚の時の削除するための商品を確認として一度表示させる処理。
  ...
  // 写真が6枚の時の削除するための商品を確認として一度表示させる処理。
  ...
  // 写真が7枚の時の削除するための商品を確認として一度表示させる処理。
  ...
  // 写真が8枚の時の削除するための商品を確認として一度表示させる処理。
