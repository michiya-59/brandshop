...
// 追加する写真が4枚の時に4枚分の写真を表示させる処理

// caseが7枚の時に情報をPOSTで受け取る処理
...
// 写真が7枚の時の全ての情報を出品完了させる画面で使う情報をhiddenで渡す処理
print '<form action="product_add_done7.php" method="post">';
