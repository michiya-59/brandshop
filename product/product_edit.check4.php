...
// product_edit.gazou4.phpから送られてきた、変更するため情報をPOSTで受け取る
...
{
  // 修正完了を行うための情報をhiddenで渡している
  print '上記のように変更しますか？';
  print '<form action="product_edit_done4.php" method="post">';
