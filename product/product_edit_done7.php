...
// product_edit.check7.phpから送られてきた、変更するため情報をPOSTで受け取る
try
{
...
$sql = 'UPDATE mst_product SET name=?,price=?,gazou=?,gazou2=?,gazou3=?,gazou4=?,gazou5=?,gazou6=?,gazou7=?,size=?,condetion=?,detail=?,stock=?,category=?,brand=? WHERE code=?';
