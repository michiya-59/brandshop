...
// product_add_check6からhiddenで送られてきた情報をPOSTで受け取る
try
{
...
$sql = 'INSERT INTO mst_product (name,price,gazou,gazou2,gazou3,gazou4,gazou5,gazou6,size,condetion,detail,stock,category,brand) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
