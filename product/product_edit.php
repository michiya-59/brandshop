...
// product_branchによって商品を修正する処理

try
{
$product_code = $_GET['productcode']; //product_branch.phpからURLパラメータによって商品コードGETで受け取る

// データーベースから全ての商品情報を条件商品コードで取り出している処理
...
?>
  ...
  <?php
  // 写真が4枚の時に4枚の写真を表示させ、写真を何枚に修正するか、またそのほかの全ての商品情報を修正するための処理
  if($product_gazou_name4_old === $product_gazou_name4_old && $product_gazou_name5_old === '')
  {
    ...
    print $disp_gazou; //ここから変更する前の写真を一度表示。
    print $disp_gazou2;
    print $disp_gazou3;
    print $disp_gazou4;//ここ変更までする前の写真を一度表示
    print '<br><br>';
    print '個数<br>';
  ...
  // 写真が5枚の時に5枚の写真を表示させ、写真を何枚に修正するか、またそのほかの全ての商品情報を修正するための処理
  if($product_gazou_name5_old === $product_gazou_name5_old && $product_gazou_name6_old === '')
  {
    ...
    print $disp_gazou3;
    print $disp_gazou4;
    print $disp_gazou5; //ここまで変更する前の写真を一度表示
    print '<br><br>';
    print '個数<br>';
    print '<select name="stock">';
      print '<option value="0">0個</option>';
  ...
  // 写真が6枚の時に6枚の写真を表示させ、写真を何枚に修正するか、またそのほかの全ての商品情報を修正するための処理
  if($product_gazou_name6_old === $product_gazou_name6_old && $product_gazou_name7_old === '')
  {
    ...
    print $disp_gazou4;
    print $disp_gazou5;
    print $disp_gazou6; //ここまで変更する前の写真を一度表示
    print '<br><br>';
    print '個数<br>';
    print '<select name="stock">';
      print '<option value="0">0個</option>';
  ...
  // 写真が7枚の時に7枚の写真を表示させ、写真を何枚に修正するか、またそのほかの全ての商品情報を修正するための処理
  if($product_gazou_name7_old === $product_gazou_name7_old && $product_gazou_name8_old === '')
  {
    ...
    print $disp_gazou5;
    print $disp_gazou6;
    print $disp_gazou7; //ここまで変更する前の写真を一度表示
    print '<br><br>';
    print '個数<br>';
    print '<select name="stock">';
      print '<option value="0">0個</option>';
  ...
  // 写真が8枚の時に8枚の写真を表示させ、写真を何枚に修正するか、またそのほかの全ての商品情報を修正するための処理
  if($product_gazou_name8_old === $product_gazou_name8_old)
  {
    ...
    print $disp_gazou6;
    print $disp_gazou7;
    print $disp_gazou8;//ここまで変更する前の写真を一度表示
    print '<br><br>';
    print '個数<br>';
    print '<select name="stock">';
      print '<option value="0">0個</option>';
