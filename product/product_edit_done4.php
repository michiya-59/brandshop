...
// product_edit.check4.phpから送られてきた、変更するため情報をPOSTで受け取る
try
{
...
$sql = 'UPDATE mst_product SET name=?,price=?,gazou=?,gazou2=?,gazou3=?,gazou4=?,size=?,condetion=?,detail=?,stock=?,category=?,brand=? WHERE code=?';
