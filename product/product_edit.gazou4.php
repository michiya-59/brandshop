...
// product_edit.phpから送られた変更する情報をPOSTで受け取る
...
else
{
  ...
  switch($product_gazou)
  {
    ...
    case '4':
      ...
      print '<input type="file" name="gazou1" style="width:400px"><br>';//ここから4枚分の写真をtype="file"で変更したい写真を選択する
      print '<input type="file" name="gazou2" style="width:400px"><br>';
      print '<input type="file" name="gazou3" style="width:400px"><br>';
      print '<input type="file" name="gazou4" style="width:400px"><br><br>';//ここまで4枚分の写真をtype="file"で変更したい写真を選択する
      // 修正するために必要な情報をhiddenで次に渡す処理
    ...
    case '5':
      ...
      print '<input type="file" name="gazou1" style="width:400px"><br>';//ここから5枚分の写真をtype="file"で変更したい写真を選択する
      print '<input type="file" name="gazou2" style="width:400px"><br>';
      print '<input type="file" name="gazou3" style="width:400px"><br>';
      print '<input type="file" name="gazou4" style="width:400px"><br>';
      print '<input type="file" name="gazou5" style="width:400px"><br><br>';//ここまで5枚分の写真をtype="file"で変更したい写真を選択する
      // 修正するために必要な情報をhiddenで次に渡す処理
      print '<input type="hidden" name="code" value="'.$product_code.'">';
      print '<input type="hidden" name="name" value="'.$product_name.'">';
      print '<input type="hidden" name="price" value="'.$product_price.'">';
    ...
    case '6':
      ...
      print '<input type="file" name="gazou1" style="width:400px"><br>';//ここまで6枚分の写真をtype="file"で変更したい写真を選択する
      print '<input type="file" name="gazou2" style="width:400px"><br>';
      print '<input type="file" name="gazou3" style="width:400px"><br>';
      print '<input type="file" name="gazou4" style="width:400px"><br>';
      print '<input type="file" name="gazou5" style="width:400px"><br>';
      print '<input type="file" name="gazou6" style="width:400px"><br><br>';//ここまで6枚分の写真をtype="file"で変更したい写真を選択する
      //修正するために必要な情報をhiddenで次に渡す処理
      print '<input type="hidden" name="code" value="'.$product_code.'">';
      print '<input type="hidden" name="name" value="'.$product_name.'">';
      print '<input type="hidden" name="price" value="'.$product_price.'">';
    ...
    case '7':
      ...
      print '<input type="file" name="gazou1" style="width:400px"><br>';//ここから7枚分の写真をtype="file"で変更したい写真を選択する
      print '<input type="file" name="gazou2" style="width:400px"><br>';
      print '<input type="file" name="gazou3" style="width:400px"><br>';
      print '<input type="file" name="gazou4" style="width:400px"><br>';
      print '<input type="file" name="gazou5" style="width:400px"><br>';
      print '<input type="file" name="gazou6" style="width:400px"><br>';
      print '<input type="file" name="gazou7" style="width:400px"><br><br>';//ここまで7枚分の写真をtype="file"で変更したい写真を選択する
      // 修正するために必要な情報をhiddenで次に渡す処理
      print '<input type="hidden" name="code" value="'.$product_code.'">';
      print '<input type="hidden" name="name" value="'.$product_name.'">';
      print '<input type="hidden" name="price" value="'.$product_price.'">';
    ...
    case '8':
      ...
      print '<input type="file" name="gazou1" style="width:400px"><br>';//ここから8枚分の写真をtype="file"で変更したい写真を選択する
      print '<input type="file" name="gazou2" style="width:400px"><br>';
      print '<input type="file" name="gazou3" style="width:400px"><br>';
      print '<input type="file" name="gazou4" style="width:400px"><br>';
      print '<input type="file" name="gazou5" style="width:400px"><br>';
      ...
      print '<input type="file" name="gazou8" style="width:400px"><br><br>';//ここまで8枚分の写真をtype="file"で変更したい写真を選択する
      // 修正するために必要な情報をhiddenで次に渡す処理
      print '<input type="hidden" name="code" value="'.$product_code.'">';
      print '<input type="hidden" name="name" value="'.$product_name.'">';
      print '<input type="hidden" name="price" value="'.$product_price.'">';
