...
// product_deletから受け取った写真が8枚時に削除する情報をPOSTで受け取る
try
{
...
$product_gazou7 = $_POST['gazou7'];
$product_gazou8 = $_POST['gazou8'];
...
// 各それぞれの写真が空では無かった場合にunlinkで写真を削除しているif($product_gazou !== '')
{
...
if($product_gazou7 !== '')
{
  unlink('./gazou/'.$product_gazou7);
}
if($product_gazou8 !== '')
{
  unlink('./gazou/'.$product_gazou8);
}
