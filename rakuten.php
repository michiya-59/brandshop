...
<body>
    ...
    <div class="container API">
        ...
        <main>
            ...
            <p class="rakuten-p">日本最大級の膨大な商品群の中からお求めの商品を快速表示します。
            ...
            <?php
                ...
                ?>
             <form method="get">
                <input type="text" name="word" placeholder="キーワード" class="serch">
                <input type="submit" value="探す" class="serch-btn">
            </form>

            <p class="rakuten-p2">「条件検索の入力例：グッチ 腕時計」</p>
            <div class="serch-total">全 <?php echo $allCount;?>件   <?php echo $firstCount;?>件～<?php echo $lastCount;?>件（<?php echo $hits;?>件表示）</div>
            <?php
            ...
            <br>
            <?php if($prevPage != 0):?>
            <a href="rakuten.php?page=<?php echo $prevPage;?>&word=<?php print $keyword; ?>" class="prev-btns">前へ</a>
            <?php endif;?>
            <a href="rakuten.php?page=<?php echo $nextPage;?>&word=<?php print $keyword; ?>" class="next-btns">次へ</a>
            <?php if($nowPage >= 2): ?>
            <a href="rakuten.php?page=1&word=<?php print $keyword; ?>" class="next-btns">スタートページに戻る</a>
            <?php endif; ?>
            <a href="index.php" class="next-btns">ショップへ</a>
        </main>
        ...
        <footer>
            ...
            <div class="footer-part1">
                ...
                <a href="https://www.rakuten.co.jp/"><img src="https://webservice.rakuten.co.jp/img/credit/200709/credit_31130.gif" class="footer-rakuten-img" ></a>
            </div>
        </footer>
    </div>
</body>
