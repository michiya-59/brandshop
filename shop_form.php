...
<div class="container">
  ...
  <form action="shop_form_check.php" method="post" class="shop-form">
    <div class="form-part">
    ...
    <input type="radio" name="chumon" value="chumonkonkai" checked><p class="form-p">今回だけの注文</p><br>
    <input type="radio" name="chumon" value="chumontouroku"><p class="form-p">会員登録しての注文</p><br><br>
    <p class="form-p">※会員登録する方は以下の項目も入力してください。</p><br>
